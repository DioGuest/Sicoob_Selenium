...
def executar_processo_CSS(caminho_do_driver, usuario, senha, Numeros):
    ...
    try:
        ...
        try:
            ...
            result_message = f"Maquina: {Numeros} Foi force Offline *ISOLADA* no balanceador CSS."  # Mensagem de sucesso

        except TimeoutException:
            result_message = f"(Proces.*ISOLAR*)A Maquina {Numeros} NAO foi encontrada na lista do Balanceador CSS."
