...
def executar_processo_4007(caminho_do_driver, usuario, senha, Numeros):
    ...
    try:
        ...
        try:
            ...
            result_message = f"Maquina: {Numeros} Foi force Offline *ISOLADA* no balanceador 4007."
        except TimeoutException:
            result_message = f"(Proces.*ISOLAR*) A Maquina {Numeros} NAO foi encontrada na lista do Balanceador 4007."
