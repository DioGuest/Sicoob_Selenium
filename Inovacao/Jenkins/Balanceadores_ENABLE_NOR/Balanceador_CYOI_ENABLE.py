...
def executar_processo_CYOI_ENABLE(caminho_do_driver, usuario, senha, Numeros):
    ...
    try:
        ...
        driver.get('https://10.100.125.241/tmui/login.jsp')
        ...
        try:
            ...
            result_message = f"(Proces.*HABILITAR*) Maquina: {Numeros} Foi habilitada *ENABLE* no balanceador CYOI."

        except TimeoutException:
                result_message = f"(Proces.*HABILITAR*) A Maquina {Numeros} NAO foi encontrada na lista do Balanceador CYOI."
