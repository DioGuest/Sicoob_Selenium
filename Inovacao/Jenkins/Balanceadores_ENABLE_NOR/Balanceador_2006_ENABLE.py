...
def executar_processo_2006_ENABLE(caminho_do_driver, usuario, senha, Numeros):
    ...
    try:
        ...
        try:
            ...
            result_message = f"(Proces.*HABILITAR*) Maquina: {Numeros} Foi habilitada *ENABLE* no balanceador 2006."
        except TimeoutException:
            result_message = f"(Proces.*HABILITAR*) A maquina {Numeros} NAO foi encontrada na lista do Balanceador 2006."
