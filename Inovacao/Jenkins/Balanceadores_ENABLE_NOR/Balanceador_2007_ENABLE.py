...
def executar_processo_2007_ENABLE(caminho_do_driver, usuario, senha, Numeros):
    ...
    try:
        ...
        driver.get("https://bigp2007.sicoob.com.br/tmui/login.jsp")
        ...
        try:
            ...
            result_message = f"(Proces.*HABILITAR*) Maquina: {Numeros} Foi habilitada *ENABLE* no balanceador 2007."
        except TimeoutException:
            result_message = f"(Proces.*HABILITAR*) A maquina {Numeros} NAO foi encontrada na lista do Balanceador 2007."
