...
RestartCompleto = Blueprint('RestartCompleto', __name__)
...
@RestartCompleto.route('/IsolarERestartEnable')
def index5():
    return render_template('index5.html')

@RestartCompleto.route('/submitIsolarRestartEnable', methods=['POST'])
