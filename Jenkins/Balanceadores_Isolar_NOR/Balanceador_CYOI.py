...
def executar_processo_CYOI(caminho_do_driver, usuario, senha, Numeros):
    ...
    try:
        ...
        try:
            ...
            result_message = f"Maquina: {Numeros} Foi force Offline *ISOLADA* no balanceador CYOI."

        except TimeoutException:
                result_message = f"(Proces.*ISOLAR*) A Maquina {Numeros} NAO foi encontrada na lista do Balanceador CYOI."
