...
def executar_processo_4007_ENABLE(caminho_do_driver, usuario, senha, Numeros):
    ...
    try:
        ...
        driver.get("https://bigp4007.sicoob.com.br/tmui/login.jsp")
        ...
        try:
            ...
            result_message = f"(Proces.*HABILITAR*) Maquina: {Numeros} Foi habilitada *ENABLE* no balanceador 4007."
        except TimeoutException:
            result_message = f"(Proces.*HABILITAR*) A Maquina {Numeros} NAO foi encontrada na lista do Balanceador 4007."
